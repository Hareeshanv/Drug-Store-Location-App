...
public class RegisterPage extends AppCompatActivity {
    ...
    EditText etUserName, etAddressLine1, etAddressLine2, etMobile, etEmailID;
    Spinner spinnerCity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String UserID="";
                        String query1 = "Select ID from tblUser order by 1 Desc";
                        ...
                        String query2 = "Insert into tblUser (ID,UserName,AddressLine1,AddressLine2,City," +
     ...
     /*   findViewById(R.id.registerimg).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
                startActivity(new Intent(getApplicationContext(),LoginPage.class));
    ...
    private boolean setValidation() {
        ...
        boolean isUserName, isAddressLine1,isMobile,isEmailID;
        ...
        if(isUserName==true && isAddressLine1==true && isMobile==true && isEmailID==true)
            return true;
        else
            return false;
    }

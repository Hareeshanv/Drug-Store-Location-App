...
public class LoginPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login =findViewById(R.id.materiallogin);
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if (conn == null) {
                        ...
                        String query1 = "Select * from tblLogin where UserID='" + txtUserID.getText().toString() + "' and Password='" + txtPassword.getText().toString() + "' and UserType='DBoy'";
